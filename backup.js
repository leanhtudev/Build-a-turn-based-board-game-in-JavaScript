...
$( document ).ready(function() {
  ...
  //subtract position of Player1 of out available spot list
...
//create Player2's position
  ...
  //subtract position of Player2 of out available spot list
    	...
    	if(pressIndex<3){
    		if(moveStatus==1){
			    ...
			    case 37:    //left arrow key
			    	var check=randomPosition1-1;			    	
			    		if(availableSpot.indexOf(check)!=-1 && avoidLeftSideMove.indexOf(check)==-1){			    		
			    		var previous=randomPosition1;			    
			        	randomPosition1--;			        				        				        	
			        	pressIndex++;
			        	weaponCheck(previous,randomPosition1);
			        	playersTouch(randomPosition1,randomPosition2);
			    		} 			    	
			        break;
				    case 38:    //up arrow key
				    	var check=randomPosition1-10;				       
				...
				switch (e.which){
					    case 37:    //left arrow key					    	
					    	var check=randomPosition2-1;					    					    	
					    		if(availableSpot.indexOf(check)!=-1 && avoidLeftSideMove.indexOf(check)==-1){					    		
					    		var previous=randomPosition2;
					        	randomPosition2--;					        						        	
					        	pressIndex++;
					        	weaponCheck(previous,randomPosition2);
					        	playersTouch(randomPosition1,randomPosition2);
					    		} 					    	
					        break;
					    case 38:    //up arrow key
					    	var check=randomPosition2-10;					        
					        	if(availableSpot.indexOf(check)!=-1){					        		
					        		var previous=randomPosition2;
					       			randomPosition2-=10;				       								       			
					       			pressIndex++;
...
function changeStatus(){
	if(moveStatus==1 && pressIndex==3){
		moveStatus=2;
		pressIndex=0;
		


	}else if(moveStatus==2 && pressIndex==3){
		moveStatus=1;
		pressIndex=0;
	}
